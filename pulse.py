...
list_of_games = games_file_dict['games'][0]['endpoints']
...
games_seasons_dict={
    ...
    "venue": match_dictionary.get('venue'),
    ...
    "league_id":generate_uuid(league_id,data_source=data_source) ,
