...
def teams_xp_calculation(row) -> pd.DataFrame:
    ...
    #unqiue ids in team_ids
    team_id='86ba9591-04bb-59ae-8db9-1d58e18318fb'
    away_id='5a453f4b-c796-520a-bff2-6b1c68d0d570'
    ...
    if row['action'] in xP_ratings and row['team_id'] == team_id:
        row['home_team_xP'] = xP_ratings[row['action']]
    elif row['action'] in xP_ratings and row['team_id'] == away_id:
    ...
    row['score_diff'] = row['team_score'] - row['opposition_score']
